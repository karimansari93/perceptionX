...
-- Applied to production as migration version 20260408122858; this file was
-- back-filled afterwards and therefore post-dates the deployment.


-- Step 1: Canonicalisation — merge variants into canonical names
...
-- Step 2: Tiers for all Oil & Gas companies currently missing them
INSERT INTO company_employee_tiers (company_name, estimated_tier, confidence, classified_by, classified_at)
VALUES
  -- Already canonicalised above, insert under canonical name
  ...
  ('Hilcorp Energy Company',        '500-4999',  'medium', 'manual', now()),
