...
-- Applied to production as migration version 20260218102641; this file was
-- back-filled afterwards and therefore post-dates the deployment.


-- Fix: Join by exact URL instead of domain to get per-company relevance scores
-- Step 1: Drop the RLS-safe view (depends on MV)
...
-- Step 3: Recreate MV with exact URL join
