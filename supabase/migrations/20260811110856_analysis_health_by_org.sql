...
-- Applied to production as migration version 20260811110856; this file was
-- back-filled afterwards and therefore post-dates the deployment.

-- Per-organization analysis readiness. See
-- supabase/migrations/20260811160000_analysis_health_by_org.sql for the full
-- rationale and the timing discipline this plan depends on.
...
BEGIN
  ...
  WITH cand AS MATERIALIZED (
    ...
    SELECT oc.org_id, sum(m.missing) AS themes_missing
    FROM org_co oc
