...
-- Applied to production as migration version 20260813041950; this file was
-- back-filled afterwards and therefore post-dates the deployment.

-- Two additions driven by client feedback:
--
-- 1. is_local — marks a market's own platform (kununu in DE, undelucram.ro in
--    RO, AmbitionBox in IN...). Local pages get badged and sorted FIRST, ahead
--    of higher-coverage global platforms: a review on the local platform is
--    read by people actually looking at this employer in this country, and it
--    is not diluted across every market the way a Glassdoor review is. This is
--    a curation decision, not a coverage ranking — see the spec's rule that
--    "most cited" and "best place for this person to post" differ.
--
-- 2. activate_route_highlights — the specific pages AI cites most for a
--    platform in a market ("what AI reads most"), so a recipient sees the
--    actual conversation rather than a bare platform link. Labels are written
--    by hand from descriptive URL slugs; pages whose content cannot be
--    verified from the URL are not seeded.
