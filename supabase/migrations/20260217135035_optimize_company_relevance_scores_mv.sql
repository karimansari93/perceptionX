...
-- Applied to production as migration version 20260217135035; this file was
...
-- Recreate MV with optimized join (uses urc.domain instead of recomputing from urc.url)
