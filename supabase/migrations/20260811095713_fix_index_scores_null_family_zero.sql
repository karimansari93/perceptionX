...
-- Applied to production as migration version 20260811095713; this file was
...
-- supabase/tests/rankings_score_null_family_regression.sql (perceptionX repo).
--
...
COMMENT ON FUNCTION public.index_family_score(text[], text[], text[]) IS
  'Share-of-slice visibility score (0-100, 1dp) for a model family. family_patterns are ILIKE patterns (NULL = all models). Returns 0, not 100, when the slice has no combinations for the family.';
