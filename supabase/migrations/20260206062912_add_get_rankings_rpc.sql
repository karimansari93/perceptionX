...
-- Applied to production as migration version 20260206062912; this file was
...
BEGIN
  -- 1. Calculate Total Combinations (Denominator) for this specific filter
  ...
  SELECT
    ...
    cs.themes,
    ARRAY[p_industry] as all_industries -- simplified
